						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<div class="h3 text-xs font-weight-bold text-success text-uppercase mb-1">
									<a href="<?= base_url('surat_masuk'); ?>" target="_blank" style="text-decoration: none; color: inherit;">
										Surat Masuk
									</a>
								</div>
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<div class="h3 text-xs font-weight-bold text-danger text-uppercase mb-1">
									<a href="<?= base_url('surat_keluar'); ?>" target="_blank" style="text-decoration: none; color: inherit;">
										Surat Keluar
									</a>
								</div>
								<div class="h5 mb-0 font-weight-bold text-gray-800">
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
									<a href="<?= base_url('disposisi'); ?>" target="_blank" style="text-decoration: none; color: inherit;">
										Disposisi
									</a>
								</div>
								<div class="h5 mb-0 font-weight-bold text-gray-800">
